# Antigravity-Linktree — Claude Instructions
...
`Antigravity-Linktree/` → `antigravity-central` pe Cloud Run. Hub central. Safe-check `pwd` inainte de deploy. Mismatch → BLOCKED.
